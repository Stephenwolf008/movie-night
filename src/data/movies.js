...
const hostedPoster = (file) => localPoster(`posters/${file}`);
...
export const movies = [
  ...
  },
  {
    ...
    certification: "A",
    mood: ["Fun", "Action"],
    posterUrl: hostedPoster("vibe.jpg"),
  ...
  },
  {
    ...
    posterUrl: hostedPoster("resident-evil.jpg"),
  ...
  },
  {
    ...
    posterUrl: hostedPoster("mirzapur-the-movie.jpg"),
  ...
  },
  {
    ...
    certification: "NR",
    mood: ["Action", "Interesting"],
    posterUrl: hostedPoster("spider-man-brand-new-day.jpg"),
  ...
  },
  {
    ...
    certification: "PG",
    mood: ["Fun", "Feel-good"],
    posterUrl: hostedPoster("magic-faraway-tree.jpg"),
